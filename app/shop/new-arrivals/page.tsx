      ...
      <section className="py-12 lg:py-16 bg-gradient-to-b from-card/50 to-background">
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <p className="blinker-regular text-xl text-muted-foreground max-w-2xl">
            Fresh styles, bold designs. Limited quantities available.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <label className="blinker-regular text-sm text-muted-foreground">
                Sort by:
              </label>
              <select
                value={sortBy}
                onChange={(e) => setSortBy(e.target.value)}
                className="bg-card border border-border rounded-lg px-4 py-2 blinker-regular text-sm focus:outline-none focus:ring-2 focus:ring-primary"
              >
            ...
            {products.map((product) => (
              <div key={product.id} className="group">
                <div className="relative bg-card rounded-lg overflow-hidden aspect-[3/4] mb-4">
                  ...
                  {product.isNew && (
                    <div className="absolute top-3 left-3 bg-primary text-primary-foreground blinker-bold text-xs px-3 py-1 rounded-full uppercase z-10">
                      New
                    </div>
                  )}
